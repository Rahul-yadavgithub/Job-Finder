  ...
  return (
    <div className="w-full space-y-8 pb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        {/* Confirmed Drives */}
        <Link href="/admin/drives" className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#1e293b] to-[#334155] p-6 shadow-lg shadow-slate-900/20 hover:shadow-xl transition-all duration-300 group hover:-translate-y-1 flex flex-col justify-between h-[180px] border border-white/10">
          <Building2 className="absolute -right-4 -bottom-4 w-32 h-32 text-white opacity-10 group-hover:scale-110 transition-transform duration-500" />
          <div className="relative z-10">
            <div className="w-10 h-10 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center mb-3">
              <Building2 className="w-5 h-5 text-white" />
            </div>
            <p className="text-sm font-bold text-white/80 uppercase tracking-widest mb-1">Confirmed Company</p>
          </div>
          <div className="relative z-10 flex items-end justify-between">
            <p className="text-4xl font-black text-white">{compStats.confirmed}</p>
            <ChevronRight className="text-white/50 group-hover:text-white transition-colors" />
          </div>
        </Link>
